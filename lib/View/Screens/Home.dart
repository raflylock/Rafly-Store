import 'package:raflyAAS/View/Component/Category.dart';
import 'package:raflyAAS/View/Screens/Detail.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'TOKO ELEKTRONIK',
          style: TextStyle(color: Color.fromARGB(255, 250, 250, 250), fontWeight: FontWeight.w600),
        ),
      ),
      body: Column(
        children: [
